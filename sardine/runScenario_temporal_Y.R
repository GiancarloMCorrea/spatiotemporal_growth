# ------------------------------------------------------------------------------
# VARIABILITY IN K PARAMETER: OM

# ------------------------------------------------------------------------------
# Run scenario_temporal: (OM 1 area and EM 1 area): OM has year effect and EM is constant

om = "scenario_base/sard-om"
em = "scenario_base/sard-em"
scenarioName = 'D1-E0-F0-R1-sard'

if(!biasAdjust){

    ctlfile <- readLines(file.path(em, 'sardEM.ctl'))
    ...
    writeLines(ctlfile, file.path(em, 'sardEM.ctl'))
...
# ------------------------------------------------------------------------------
# Run scenario_temporal: (OM 1 area and EM 1 area): year effect for OM and EM is year effect ts

om = "scenario_temporal_OM-Y_EM-Y-ts_K/sard-om"
em = "scenario_temporal_OM-Y_EM-Y-ts_K/sard-em"
scenarioName = 'D1-E0-F0-R2-sard'
...
foreach(ix = 1:nSim) %dopar% {
  ...
  ss3sim_base(iterations = ix, scenarios = scenarioName,
              ...
              iniY = iniFyear, endY = nyears, age_env_obs = age_env_obs)
...
# ------------------------------------------------------------------------------
# Run scenario_temporal: (OM 1 area and EM 1 area): year effect for OM and EM is year effect devs

om = "scenario_temporal_OM-Y_EM-Y-dev_K/sard-om"
em = "scenario_temporal_OM-Y_EM-Y-dev_K/sard-em"
scenarioName = 'D1-E0-F0-R3-sard'
...
# ------------------------------------------------------------------------------
# VARIABILITY IN Linf PARAMETER: OM
...
E0 = list(natM_type = NULL, natM_n_breakpoints = NULL, natM_lorenzen = NULL, 
          ...
          par_int = c(base_natM), par_phase = c(6), forecast_num = 0) # This is not altering anything
# Standard (apply to OM):
G1 = list(L_at_Amax_Fem_GP_1 = growthindex3$index) # check time varying parameters later
R2 = list(retro_yr = 0)
...
om = "scenario_temporal_OM-Y_EM-Y-ts_Linf/sard-om"
em = "scenario_temporal_OM-Y_EM-Y-ts_Linf/sard-em"
scenarioName = 'D1-E2-F0-R2-sard'
...
om = "scenario_temporal_OM-Y_EM-Y-dev_Linf/sard-om"
em = "scenario_temporal_OM-Y_EM-Y-dev_Linf/sard-em"
scenarioName = 'D1-E2-F0-R3-sard'
