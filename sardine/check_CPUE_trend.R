...
for(i in 1:nSim){
	...
	mod_name = paste0('saveRuns/D2-E1-F1-R2-sard/', i, '/em')
...
p1 = ggplot(newdat, aes(x = year)) +
		  ...
		  scale_y_continuous(breaks=c(-200, -150, -100, -50, 0, 50), position = 'left') +
...
for(i in 1:nSim){
	...
	mod_name = paste0('saveRuns/D2-E1-F2-R2-sard/', i, '/em')
...
for(i in 1:nSim){
	...
	mod_name = paste0('saveRuns/D2-E1-F3-R2-sard/', i, '/em')
...
for(i in 1:nSim){
	...
	mod_name = paste0('saveRuns/D2-E3-F1-R2-sard/', i, '/em')
...
for(i in 1:nSim){
	...
	mod_name = paste0('saveRuns/D2-E3-F2-R2-sard/', i, '/em')
...
for(i in 1:nSim){
	...
	mod_name = paste0('saveRuns/D2-E3-F3-R2-sard/', i, '/em')
...
png('Supp_Indices_Diff_Sard.png', width = 170, height = 120, units = 'mm', res = 500)
