...
dir.create(path = paste0(nameScenario, '/sard-om'))
dir.create(path = paste0(nameScenario, '/sard-em'))

#Files OM:
OMpath = 'core_omem/OM_base'
listFiles = list.files(path = OMpath)
file.copy(file.path(OMpath, listFiles), paste0(nameScenario, '/sard-om'))
#Files EM:
EMpath = 'core_omem/EM_base'
listFiles = list.files(path = EMpath)
file.copy(file.path(EMpath, listFiles), paste0(nameScenario, '/sard-em'))


# -------------------------------------------------------
# 2-1) Temporal scenario: (OM has year effect and EM consider it - ts): K var
...
# -------------------------------------------------------
# 2-2) Temporal scenario: (OM has year effect and EM consider it - devs): K var
...
# -------------------------------------------------------
# 2-3) Temporal scenario: (OM has year effect and EM consider it - ts): Linf var
...
# -------------------------------------------------------
# 2-4) Temporal scenario: (OM has year effect and EM consider it - devs): Linf var
