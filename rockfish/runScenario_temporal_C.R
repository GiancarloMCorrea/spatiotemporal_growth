...
om = "scenario_temporal_OM-C_EM-C-ts/rock-om"
em = "scenario_temporal_OM-C_EM-C-ts/rock-em"
scenarioName = 'D1-E1-F0-R2-rock'
...
om = "scenario_temporal_OM-C_EM-C-dev/rock-om"
em = "scenario_temporal_OM-C_EM-C-dev/rock-em"
scenarioName = 'D1-E1-F0-R3-rock'
