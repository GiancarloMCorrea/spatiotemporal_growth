...
scenarioName = 'D1-E0-F0-R1-rock'

if(!biasAdjust){

    ctlfile <- readLines(file.path(em, 'rockEM.ctl'))
    ...
    writeLines(ctlfile, file.path(em, 'rockEM.ctl'))
...
om = "scenario_temporal_OM-Y_EM-Y-ts_K/rock-om"
em = "scenario_temporal_OM-Y_EM-Y-ts_K/rock-em"
scenarioName = 'D1-E0-F0-R2-rock'
...
om = "scenario_temporal_OM-Y_EM-Y-dev_K/rock-om"
em = "scenario_temporal_OM-Y_EM-Y-dev_K/rock-em"
scenarioName = 'D1-E0-F0-R3-rock'
...
om = "scenario_temporal_OM-Y_EM-Y-ts_Linf/rock-om"
em = "scenario_temporal_OM-Y_EM-Y-ts_Linf/rock-em"
scenarioName = 'D1-E2-F0-R2-rock'
...
om = "scenario_temporal_OM-Y_EM-Y-dev_Linf/rock-om"
em = "scenario_temporal_OM-Y_EM-Y-dev_Linf/rock-em"
scenarioName = 'D1-E2-F0-R3-rock'
