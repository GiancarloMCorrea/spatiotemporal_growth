...
120 120 120 120 120 120 1 120 1 120
...
121  #FirstYear for caps and allocations (should be after years with fixed inputs)
0 # stddev of log(realized catch/target catch) in forecast (set value>0.0 to cause active impl_error)
0 # Do West Coast gfish rebuilder output (0/1)
120 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
120 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
