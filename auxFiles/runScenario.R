# REMEMBER:
# 1) We have to run this script twice. First, to estimate bias_adjust parameters, then find their average.
# Second, to run the real simulation.
...
scenarioName = paste0('D0-', growthTempIndex, '-F0-R0-cod')
...
scenarioName = paste0('D0-', growthTempIndex, '-F0-R1-cod')
...
foreach(ix = 1:nSim) %dopar% {
  ...
  ss3sim_base(iterations = ix, scenarios = scenarioName,
              ...
              bias_adjust = biasAdjust, transformFleets = tranfList, area_fleet_em = areaList)
...
E0 = list(natM_type = NULL, natM_n_breakpoints = NULL, natM_lorenzen = NULL, 
          natM_val= NULL, par_name = c("NatM_p_1_Fem_GP_1"),
          par_int = c(0.34), par_phase = c(3), forecast_num = 0) # This is not altering anything
G1 = list(VonBert_K_Fem_GP_1 = growthindex$index) # check time varying parameters later
R2 = list(retro_yr = 0)
...
E0 = list(natM_type = NULL, natM_n_breakpoints = NULL, natM_lorenzen = NULL, 
          natM_val= NULL, par_name = c("NatM_p_1_Fem_GP_1"),
          par_int = c(0.34), par_phase = c(3), forecast_num = 0) # This is not altering anything
G1 = list(VonBert_K_Fem_GP_1 = growthindex$index, VonBert_K_Fem_GP_2 = growthindex$index) # check time varying parameters later
R3 = list(retro_yr = 0)
...
foreach(ix = 1:nSim) %dopar% {
  ...
  ss3sim_base(iterations = ix, scenarios = scenarioName,
              ...
              tv_params = G1, bias_adjust = biasAdjust, transformFleets = tranfList, area_fleet_em = areaList)
...
om = "scenario_spatial/cod-om"
em = "scenario_spatial/cod-em"
scenarioName = paste0('D0-', growthTempIndex, '-F1-R1-cod')
...
om = "scenario_spatial/cod-om"
em = "scenario_spatial/cod-em"
scenarioName = paste0('D0-', growthTempIndex, '-F2-R1-cod')
...
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
# FOR THIS SET OF RUNS, A SPATIAL MODEL WILL BE CONSIDERED.
# ------------------------------------------------------------------------------
# ------------------------------------------------------------------------------
...
scenarioName = paste0('D1-', growthTempIndex, '-F0-R1-cod')
...
E0 = list(natM_type = NULL, natM_n_breakpoints = NULL, natM_lorenzen = NULL, 
          natM_val= NULL, par_name = c("NatM_p_1_Fem_GP_1", "NatM_p_1_Fem_GP_2"),
          par_int = c(0.34, 0.34), par_phase = c(3,3), forecast_num = 0) 
G1 = list(VonBert_K_Fem_GP_1 = growthindex$index, VonBert_K_Fem_GP_2 = growthindex$index) # Applies to OM
R3 = list(retro_yr = 0)
...
om = "scenario_2_spatial/cod-om"
em = "scenario_2_spatial/cod-em"
scenarioName = paste0('D1-', growthTempIndex, '-F1-R1-cod')
...
om = "scenario_2_spatial/cod-om"
em = "scenario_2_spatial/cod-em"
scenarioName = paste0('D1-', growthTempIndex, '-F2-R1-cod')
...
# ------------------------------------------------------------------------------
# FULL model (WORK ON THIS)
# ------------------------------------------------------------------------------
# Include env growth index for em spatiotemporal model:

# om = "scenario_2_spatiotemporal/cod-om"
# em = "scenario_2_spatiotemporal/cod-em"
# scenarioName = 'D2-E0-F0-R3-cod'
