...
#FigInx = 'D_E0_F0_R2'
#listScenarios = c('D0-E0-F0-R2-cod', 'D1-E0-F0-R2-cod')
...
#png(paste0('Figures/Ts_plots_', FigInx, '.png'), width = 90, height = 130, units = 'mm', res = 500)
#png(paste0('Figures/Ts_plots_', FigInx, '.png'), width = 140, height = 130, units = 'mm', res = 500)
...
nAreasEM = max(as.numeric(as.character(plotdfem$number_par)))
  ...
  if(nAreasOM > 1 & nAreasEM == 1) {
    ploty1 = ploty1 + geom_boxplot(color = ColorsX1, alpha = 0.3)+
    geom_point(data = plotdfom, aes(x = 0, y = parValue, color = number_par), size = 2) +
...
#png(paste0('Figures/Scalar_plots_', FigInx, '.png'), width = 90, height = 130, units = 'mm', res = 500)
...
# png(paste0('Figures/C_', FigInx, '.png'), width = 270, height = 170, units = 'mm', res = 500)
